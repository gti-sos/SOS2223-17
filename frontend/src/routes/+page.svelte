...
<section>
        ...
        <p>Our source of information is oriented to the use of bikes,number
         of self-employed people and number of emergency calls in Andalusia.</p>
        ...
        <ul>
            ...
            <li><a href=https://sos2223-17.ew.r.appspot.com/api/v1/self-employed-stats/docs>/self-employed-stats/docs</a>(developed by<a href="https://github.com/Joseg0">Jose Germinal Garrucho Orozco</a>)</li>
